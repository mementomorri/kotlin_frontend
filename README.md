...
Компонент в "anyList" внесены изменения в соответствии с заданием, компонент сформирован в список с возможностью добавлять новые элементы, студента или занятие, в зависимости от переданного массива.\
